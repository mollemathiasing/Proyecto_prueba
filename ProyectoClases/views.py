...
def mi_template (request):
    cargar_archivo = open(r'C:\Users\Mathias\Documents\Python - Coderhouse\Proyecto-clases\Templates\mi_template.html', 'r')  #llamamos el archivo al cual le queremos hacer un template
...
def tu_template (request, nombre):
    # cargar_archivo = open(r'C:\Users\Mathias\Documents\Python - Coderhouse\Proyecto-clases\Templates\tu_template.html', 'r')  #llamamos el archivo al cual le queremos hacer un template
    # template = Template(cargar_archivo.read())                                                                             #con esto generamos un template del archivo q teniamos enn html
    # cargar_archivo.close()                                                                             #cerramos el archivo
    ...
    #forma simplificada:
    template = loader.get_template('tu_template.html')    #La direccion de la carpeta no la puse completa porq la asigne en el archivo settings en DIR
...
def prueba_template (request):
    ...
    template = loader.get_template('prueba_template.html')    #La direccion de la carpeta no la puse completa porq la asigne en el archivo settings en DIR
